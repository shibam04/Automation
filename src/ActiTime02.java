	...
	public static void main(String[] args) throws InterruptedException 
	   {
		 ...
		 Thread.sleep(3000);
		// b.findElement(By.xpath("//div[@class='contentWrapper ']/descendant::div[@class='searchItemList' and @style='display: block;']/div[@class='itemRow selected']")).click();
		 b.findElement(By.xpath("//div[@class='searchItemList']/div[ contains(.,'- New Customer -')]")).click();
